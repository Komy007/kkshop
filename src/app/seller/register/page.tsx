        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 px-4">
                <div className="bg-white rounded-2xl shadow-xl p-10 max-w-md w-full text-center">
                    ...
                    <p className="text-gray-600 mb-2">셀러 파트너 신청이 접수되었습니다.</p>
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 py-12 px-4">
            <div className="max-w-2xl mx-auto">
                ...
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-3xl font-extrabold text-gray-900">셀러 파트너 신청</h1>
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-4">
                        <h2 className="text-white font-semibold">셀러 정보 입력</h2>
                    </div>
                    <form onSubmit={handleSubmit} className="p-6 space-y-5">
                        ...
                        <div className="bg-blue-50 rounded-xl p-4 text-sm text-blue-700">
                            ...
                            신청 승인 후 셀러 포털에서 상품을 등록하면 <strong>한국어·영어·크메르어·중국어</strong>로 자동 번역되어 KKShop에 등록됩니다.
                        </div>
