...
function FlashSaleCard({ item, onAddToCart }: { item: FlashSaleItem; onAddToCart: (item: FlashSaleItem) => void }) {
            ...
            <div className="bg-gradient-to-r from-red-500 via-rose-500 to-pink-500 text-white">
                <div className="max-w-screen-xl mx-auto px-4 py-6">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-black tracking-tight">⚡ Flash Sale</h1>
            ...
            <div className="max-w-screen-xl mx-auto px-4 py-6">
                {loading ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-24 text-center">
                        ...
                        <h2 className="text-xl font-bold text-gray-700 mb-2">No Active Flash Sales</h2>
                    ...
                    <>
                        <p className="text-sm text-gray-500 mb-4">
                            <span className="font-bold text-gray-800">{items.length}</span> items on flash sale
                        </p>
                        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3">
                            {items.map(item => (
                                <FlashSaleCard key={item.id} item={item} onAddToCart={handleAddToCart} />
                            ))}
                        </div>
                    </>
                )}
