...
export default function AntiGravityHero({ customData }: { customData?: any }) {
    ...
    const floatingTransition: any = { repeat: Infinity, repeatType: "mirror", ease: "easeInOut" };
    ...
    return (
        <section className="relative w-full min-h-[100svh] sm:min-h-[90vh] flex items-center justify-center overflow-hidden">
            ...
            {/* Decorative Stars (reduced on mobile for perf) */}
            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto px-5 sm:px-6 pt-8 pb-10 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                ...
                >
                    <motion.p
                        ...
                        className="text-white/80 font-medium tracking-wide drop-shadow-md text-base sm:text-lg"
                    ...
                    <p className="text-base sm:text-lg text-white/60 max-w-lg leading-relaxed font-light">
                        {t.desc}
                    </p>
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="mt-2 group relative inline-flex items-center justify-center gap-3 px-7 py-3.5 bg-white text-space-900 rounded-full font-bold overflow-hidden transition-all hover:shadow-[0_0_30px_rgba(255,255,255,0.3)]"
                    >
                ...
                {/* Mobile: horizontal scrollable strip with mini floating cards */}
                <div className="block lg:hidden w-full">
                    <div className="flex items-end gap-4 overflow-x-auto snap-x snap-mandatory pb-2 -mx-1 px-1">
                        ...
                        <motion.div
                            ...
                            className="snap-center flex-shrink-0 w-[180px] aspect-[3/4] rounded-3xl overflow-hidden glass-card shadow-[0_15px_40px_rgba(236,72,153,0.2)]"
                        >
                            <img src={img0?.url || defaultImages[0]!.url} alt="Serum" className="w-full h-full object-cover scale-110" />
                        ...
                        <motion.div
                            animate={{ y: [8, -10, 8] }}
                            transition={{ ...floatingTransition, duration: 6, delay: 0.8 }}
                            className="snap-center flex-shrink-0 w-[140px] aspect-square rounded-full overflow-hidden glass-card shadow-[0_10px_30px_rgba(99,102,241,0.25)]"
                        >
                            <img src={img1?.url || defaultImages[1]!.url} alt="Cream" className="w-full h-full object-cover" />
                        </motion.div>

                        {/* Card 3 – Accent */}
                        <motion.div
                            animate={{ y: [-6, 12, -6] }}
                            transition={{ ...floatingTransition, duration: 7, delay: 1.5 }}
                            className="snap-center flex-shrink-0 w-[160px] aspect-[4/3] rounded-2xl overflow-hidden glass-card shadow-[0_20px_50px_rgba(0,0,0,0.4)]"
                        >
                            <img src={img2?.url || defaultImages[2]!.url} alt="Foundation" className="w-full h-full object-cover" />
                        </motion.div>
                    </div>
                </div>

                {/* Desktop: original floating layout */}
                <div className="relative h-[600px] hidden lg:block perspective-1000">
                    ...
                    >
                        <img src={img0?.url || defaultImages[0]!.url} alt="Premium Serum" className="w-full h-full object-cover scale-110" />
                    ...
                    >
                        <img src={img2?.url || defaultImages[2]!.url} alt="Foundation" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                    </motion.div>
